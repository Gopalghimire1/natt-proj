        ...
        <div class="cell-md-8" >
            ...
            <form method="post" action="{{ route('admin.other.member.update',$member->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"  name="company" value="{{ $member->company }}" placeholder="Enter company name" required/>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email"  name="email" value="{{ $member->gmail }}" placeholder="Enter email" required/>
                    </div>
